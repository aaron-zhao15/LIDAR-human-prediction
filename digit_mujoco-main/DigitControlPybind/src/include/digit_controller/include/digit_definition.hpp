...
class DigitControlHyperparameters {
 public:
  ...
  double step_time_crnt;  // it is T in phasevariable computation
  double step_time_next;
  Vector3d v_StB_d;
  double stepl_d;
  double stepw_d; // nominal step width. check step_width_desired in calc_p_StSw_d_f of walking_trajectory.cpp
