...
class RaySampler(Sampler):
    ...
    def __init__(
            ...
            *,  # After this require passing by keyword.
            ...
            is_tf_worker=False,
            seed=get_seed(),
            n_workers=psutil.cpu_count(logical=False),  # this should be number of envs
        ...
        else: # usually worker_factory is none
        ...
        self._sampler_worker = ray.remote(SamplerWorker) # create a remote version of SamplerWorker class
        self._agents = agents
    ...
    def start_worker(self):
        ...
        for worker_id in range(self._worker_factory.n_workers):
            self._all_workers[worker_id] = self._sampler_worker.remote(
                ...
                self._worker_factory) # instantiate a remote worker
